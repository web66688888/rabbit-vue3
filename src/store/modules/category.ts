...
import { CategoryItem,ApiRes, TopBread ,SubResult } from '@/types/data'
...
export default defineStore ('category',{
  ...
  actions:{
   ...
   async getTopBread(id:string) {
    ...
    async getSubcatrgory(id:string) {
      const res = await axios.get('/category/sub/filter',{
        params:{
          id
        }
      })
